...
Room.prototype.runUpgrader= function(creep) {
       ...
       var source = creep.room.find(FIND_STRUCTURES,{filter:(i)=>{return(i.structureType==STRUCTURE_EXTENSION || i.structureTYPE==STRUCTURE_SPAWN)&& i.energy >= i.energyCapacity;}});
